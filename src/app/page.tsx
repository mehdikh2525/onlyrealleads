        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeIn}>
              <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  <Image src="/wasted-time.png" alt="Time wasted" width={400} height={250} className="w-full h-auto rounded-md mb-6" />
            ...
            <motion.div variants={fadeIn}>
              <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  <Image src="/CRM.png" alt="CRM polluted" width={400} height={250} className="w-full h-auto rounded-md mb-6" />
            ...
            <motion.div variants={fadeIn}>
              <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  <Image src="/ad-spend.png" alt="Ad spend" width={400} height={250} className="w-full h-auto rounded-md mb-6" />
